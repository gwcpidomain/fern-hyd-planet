...
export function AiSummarizerCard({ 
  ...
  return (
    <div className="card-vibrant relative flex h-full flex-col overflow-hidden rounded-2xl bg-slate-900/35 !p-3 backdrop-blur-2xl border border-emerald-500/[0.12] shadow-[0_6px_32px_rgba(0,0,0,0.4),inset_0_1px_0_rgba(255,255,255,0.07)]">
      {/* 1. FIXED HEADER */}
